...
@plugindesc ♦5.4.11♦ Essential plugin for all Eli plugins.
...
Eli.Utils = {
    ...
    getMapCharacter(id){
        if(id >= 0){
            const eventId = Number(id) || Eli.PluginManager.currentEventId
...
Eli.Book = {
    ...
    createParameters(){
        ...
        return {
            engine: this.createEngine(parameters.engine),
            playtest: this.createPlaytest(parameters.playtest),
        }
    },

    createEngine(rawParam){
...
Graphics._createCanvas = function() {
    ...
    this.checkCanvasToPixelPerfect()
}

Graphics.checkCanvasToPixelPerfect = function() {
